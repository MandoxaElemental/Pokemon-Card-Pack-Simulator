...
export const themedPacks: BoosterPack[] = [
  ...
  },
  {
    ...
    carouselCards: ['Mankey-56', 'Hitmontop-237', 'Hariyama-297',  'Gallade-475', 'Conkeldurr-534', 'Hawlucha-701', 'Kommo-o-784', "Sirfetch'd-865", 'Flamigo-973', 'Mega Lucario-448', 'Mega Falinks-870', 'GMax Machamp-68', 'Cobalion-638','Zamazenta (Crowned)-889', 'Koraidon-1007', 'Silvally (Fighting)-773', 'Arceus (Fighting)-493', 'Meloetta (Pirouette)-648' ],
    ...
    carouselCards: ['Sandshrew-27', 'Golem-76',  'Donphan-232','Flygon-330', 'Hippowdon-450', 'Krookodile-553', 'Diggersby-660', 'Mudsdale-750', 'Runerigus-867', 'Clodsire-980', 'Mega Garchomp-445', 'Mega Golurk-623', 'GMax Sandaconda-844', 'Landorus (Therian)-645','Bloodmoon Ursaluna-901', 'Ting-Lu-1003', 'Silvally (Ground)-773', 'Arceus (Ground)-493', 'Primal Groudon-383'],
    ...
    carouselCards: ['Onix-95', 'Aerodactyl-42', 'Sudowoodo-185', 'Aggron-306', 'Rampardos-409', 'Gigalith-526', 'Carbink-703', 'Lycanroc (Dusk)-745', 'Stonjourner-874', 'Garganacl-934', 'Mega Tyranitar-248', 'Mega Barbaracle-689', 'GMax Coalossal-839', 'Regirock-377', 'Terrakion-639', 'Nihilego-793', 'Silvally (Rock)-773', 'Arceus (Rock)-493', 'Diancie-719'],
    ...
    carouselCards: ['Pinsir-127', 'Heracross-214', 'Ninjask-291', 'Yanmega-469', 'Leavanny-542', 'Vivillon (Meadow)-666', 'Vikavolt-738', 'Frosmoth-873', 'Spidops-918', 'Mega Beedrill-15', 'Mega Golisopod-768', 'GMax Butterfree-12', 'Buzzwole-794', 'Pheromosa-795', 'Slither Wing-988', 'Silvally (Bug)-773', 'Arceus (Bug)-493', 'Genesect-649',],
    chaseCard: 'Genesect-649',
  },
    {
    id: 'ghost',
    ...
    carouselCards: ['Misdreavus-200', 'Banette-354', 'Dusknoir-477', 'Cofagrigus-563', 'Trevenant-709', 'Palossand-770', 'Dragapult-887', 'Annihilape-979', 'Mega Sableye-302', 'Mega Chandelure-609', 'GMax Gengar-94', 'Giratina (Origin)-487', 'Lunala-792', 'Spectrier-897', 'Silvally (Ghost)-773', 'Arceus (Ghost)-493', 'Marshadow-802',],
    ...
    carouselCards: ['Magnemite-81', 'Scizor-212', 'Metagross-376', 'Probopass-476', 'Klinklang-601', 'Aegislash-681', 'Klefki-707', 'Perrserker-863', 'Orthworm-968', 'Mega Steelix-208', 'Mega Excadrill-530', 'GMax Copperajah-879', 'Registeel-379','Dialga-483', 'Solgaleo-791',  'Silvally (Steel)-773','Arceus (Steel)-493', 'Melmetal-809'],
    chaseCard: 'Melmetal-809',
  },
  {
    id: 'fire',
  ...
  },
  {
    ...
    carouselCards: ['Squirtle-7', 'Vaporeon-134', 'Politoed-186', 'Wailord-321', 'Gastrodon (East)-423', 'Carracosta-565', 'Greninja-658', 'Golisopod-768', 'Barraskewda-847', 'Palafin (Hero)-964', 'Mega Gyarados-130', 'Mega Starmie-121', 'GMax Inteleon-818', 'Palkia-484', 'Tapu Fini-788', 'Ogerpon Hearthflame-1017', 'Silvally (Water)-773','Arceus (Water)-493', 'Primal Kyogre-382'],
    ...
    carouselCards: ['Bulbasaur-1', 'Exeggutor-103', 'Bellossom-182', 'Tropius-357', 'Leafeon-470',  'Amoonguss-591', 'Gogoat-673', 'Tsareena-763', 'Flapple-841', 'Arboliva-930', 'Mega Sceptile-254', 'Mega Scovillain-952', 'GMax Rillaboom-812', 'Virizion-640', 'Wo-Chien-1001', 'Ogerpon-1017',  'Silvally (Grass)-773', 'Arceus (Grass)-493', 'Celebi-251'],
    chaseCard: 'Celebi-251',
  },
    {
    id: 'electric',
    ...
    carouselCards: ['Pikachu-25', 'Jolteon-135', 'Lanturn-171', 'Manectric-310', 'Luxray-405', 'Eelektross-604', 'Heliolisk-695', 'Togedemaru-777', 'Boltund-836', 'Bellibolt-939', 'Mega Ampharos-181', 'Mega Raichu X-26', 'GMax Toxtricity-849', 'Raikou-243', 'Thundurus-642', 'Regieleki-894',  'Silvally (Electric)-773', 'Arceus (Electric)-493', 'Zeraora-807',],
    ...
    carouselCards: ['Jynx-124', 'Delibird-225', 'Walrein-365', 'Glaceon-471', 'Cryogonal-615', 'Avalugg-713', 'Ninetales (Alola)-38', 'Eiscue-875', 'Mega Glalie-362', 'Mega Crabominable-740', 'GMax Lapras-131', 'Baxcalibur-998', 'Regice-378', 'Kyurem-646', 'Chien-Pao-1002', 'Silvally (Ice)-773', 'Arceus (Ice)-493', 'Calyrex (Ice Rider)-898',],
    chaseCard: 'Calyrex (Ice Rider)-898',
  },
    {
    id: 'dragon',
    name: 'Dragon Pack',
    ...
    carouselCards: ['Umbreon-197', 'Houndoom-229', 'Shiftry-275', 'Spiritomb-442', 'Hydreigon-635', 'Malamar-687', 'Alolan Ratticate-20', 'Obstagoon-862', 'Kingambit-983', 'Mega Absol-359', 'Mega Absol Z-359', 'GMax Grimmsnarl-861', 'Yveltal-717', 'Guzzlord-799', 'Silvally (Dark)-773', 'Arceus (Dark)-493', 'Darkrai-491',],
    chaseCard: 'Darkrai-491',
  },
    {
    id: 'fairy',
    name: 'Fairy Pack',
    filter: (card: Card) => card.type.includes('Fairy'),
    carouselCards: ['Clefairy-35', 'Wigglytuff-40', 'Granbull-210', 'Mawile-303', 'Togekiss-468', 'Whimsicott-547', 'Florges (Red)-671', 'Ribombee-743', 'Tinkaton-959', 'Mega Gardevoir-282', 'Mega Clefable-36', 'GMax Alcremie-869', 'Xerneas-716', 'Zacian (Crowned)-888', 'Enamorus-905', 'Silvally (Fairy)-773', 'Arceus (Fairy)-493', 'Floette (Eternal Flower)-670',],
