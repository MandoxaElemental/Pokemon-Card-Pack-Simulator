                    ...
                    <ul className="space-y-2 mb-2">
                      <li className="flex items-center gap-2">
                        <h3 className='font-semibold'>
                          ZA Home Sprites are Here!
                        </h3>
                      </li>
                      <li>
                        ZA Mega Evolution Home Sprites Have Arrived! Go and Complete 'Go Futher Beyond' in the Achievements Tag
                      </li>
                      <li>
                        <div className='flex items-center justify-center'>
                          <div className="grid grid-cols-3 gap-2">
                            <Image src='/home-icons/154-Mega.png' alt='meganium' width={90} height={90} />
                            <Image src='/home-icons/500-Mega.png' alt='emboar' width={90} height={90} />
                            <Image src='/home-icons/160-Mega.png' alt='feraligatr' width={90} height={90} />
                            <Image src='/home-icons/149-Mega.png' alt='dragonite' width={90} height={90} />
                            <Image src='/home-icons/71-Mega.png' alt='victreebel' width={90} height={90} />
                            <Image src='/home-icons/701-Mega.png' alt='hawlucha' width={90} height={90} />
                          </div>
                        </div>
                      </li>
                    </ul>
