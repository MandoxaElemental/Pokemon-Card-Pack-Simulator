      ...
      <AnimatePresence>
        {showDex && (
          <motion.div
            ...
            className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 md:p-6"
            onClick={(e) => {
          ...
          >
            <div
              ...
              className="bg-[#E4F1F6] md:rounded-lg w-full max-w-[100vw] sm:max-w-3xl p-4 sm:p-6 text-[#2A3F55] relative overflow-y-auto max-h-[100vh] md:max-h-[90vh] center-last-row-sm"
            >
              <button
                onClick={() => {
                  setShowDex(false);
